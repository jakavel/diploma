...
\begin{document}
  ...
  \note{
  	...
  	Pri drugem za potenciale dodamo neko konstanto, da vrednosti potencialov
  	...
  	lokalizacija zelo občutljiv na veliko meritveno napako pri le eni razdalji.
  }

  \note{
  	Tretja točka govori o \emph{nonparametric belief propagation}.

  	Če algoritem izvedemo večkrat na vpetih drevesih bo gotovo na vsakem
  	drevesu konvergiral, a vsako od rezultatov upošteva le nekatere razdalje.
  	Na koncu zaupanja za dano vozlišče dobimo tako, da zmnožimo zaupanja
